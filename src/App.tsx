...
export default function App() {
  ...
  const [queryHistory, setQueryHistory] = useState<QueryHistoryItem[]>(mockQueryHistory);
  const [selectedQueryId, setSelectedQueryId] = useState<string | undefined>();
  const [knowledgeBase, setKnowledgeBase] = useState<Source[]>(mockSources);
  ...
  const handleFileUpload = (uploadedFiles: any[]) => {
    ...
    const newSources: Source[] = uploadedFiles
